...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/work-3.jpg');" data-stellar-background-ratio="0.5">
...
?>
          ...
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p><a href="https://mail.google.com/mail/u/0/#inbox"><?php  echo $row['Email'];?></a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
